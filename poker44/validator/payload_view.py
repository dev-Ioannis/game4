...
_BUILD_VARIANT_G7 = "g7"
_BUILD_FINGERPRINT_G7 = "89cd74c57744dc5935c3791c"
_BUILD_SALT_G7 = "e0b64c6a4b0b46cc"


def _build_provenance_G7():
    """Redundant per-build provenance marker (unused at runtime)."""
    return (_BUILD_VARIANT_G7, _BUILD_FINGERPRINT_G7, _BUILD_SALT_G7)
